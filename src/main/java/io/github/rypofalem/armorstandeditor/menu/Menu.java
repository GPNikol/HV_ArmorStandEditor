...
public class Menu {
	...
	private void fillInventory() {
		...
		if(pe.getPlayer().hasPermission("asedit.invulnerable")){						 // Added new option for invlunerability
			invulnerability = createIcon( new ItemStack(Material.OBSIDIAN, 1), // Should create another item in editor menu
					"invulnerability", "mode invulnerability");
		}
